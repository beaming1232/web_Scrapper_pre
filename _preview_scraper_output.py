...
filter_external -> resolve_url -> revalidate) against the live jobfound.org
...
from scrapers.sources.jobfound import JobfoundSource
...
async def main():
    source = JobfoundSource()  # default: last 24h, no fixed page count
